...
public class FyShareStandingBook implements Serializable {
    ...
    public String toString() {
        return "FyShareStandingBook{" + "id=" + id + ", standingBookName=" + standingBookName + ", associateCostCode="
                + associateCostCode + ", remark=" + remark + ", createDate=" + createDate + ", createPerson="
