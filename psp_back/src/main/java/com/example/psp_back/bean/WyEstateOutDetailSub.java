...
public class WyEstateOutDetailSub implements Serializable {
    ...
    public String toString() {
        return "WyEstateOutDetailSub{" + "id=" + id + ", belongOutProjectId=" + belongOutProjectId + ", receiveDate="
                + receiveDate + ", checkAdvice=" + checkAdvice + ", checkPersonId=" + checkPersonId
                + ", checkPersonName=" + checkPersonName + ", checkDate=" + checkDate + ", checkStatus=" + checkStatus
                + "}";
    }
}
