...
public class ZhCustomerAskFix implements Serializable {
    ...
    public String toString() {
        return "ZhCustomerAskFix{" + "id=" + id + ", cellId=" + cellId + ", proposer=" + proposer + ", proposerDate="
                + proposerDate + ", askFixContent=" + askFixContent + ", checkPerson=" + checkPerson + ", fixMoney="
                + fixMoney + ", checkDate=" + checkDate + ", checkAdvice=" + checkAdvice + ", leaderPhone="
                + leaderPhone + ", executeCompany=" + executeCompany + ", executeStartDate=" + executeStartDate
                + ", leader=" + leader + ", checkedPerson=" + checkedPerson + ", executeStopDate=" + executeStopDate
                + ", checkedDate=" + checkedDate + ", checkedAdvice=" + checkedAdvice + ", remark=" + remark
                + ", status=" + status + ", createPerson=" + createPerson + ", createDate=" + createDate + ", identify="
                + identify + ", confirmPerson=" + confirmPerson + ", confirmDate=" + confirmDate + ", checkedAttach="
                + checkedAttach + ", referAttach=" + referAttach + ", phoneNumber=" + phoneNumber + "}";
    }
}
