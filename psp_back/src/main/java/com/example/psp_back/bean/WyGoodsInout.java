...
public class WyGoodsInout implements Serializable {
    ...
    public String toString() {
        return "WyGoodsInout{" + "id=" + id + ", inoutDate=" + inoutDate + ", carryPerson=" + carryPerson + ", idCard="
                + idCard + ", inputType=" + inputType + ", liveAddr=" + liveAddr + ", inoutUnit=" + inoutUnit
                + ", customerName=" + customerName + ", inoutGoods=" + inoutGoods + ", agent=" + agent + ", remark="
