...
public class TblLoginLog implements Serializable {
    ...
    public String toString() {
        return "TblLoginLog{" + "id=" + id + ", loginDate=" + loginDate + ", loginIp=" + loginIp + ", loginStatus="
                + loginStatus + ", openMk=" + openMk + ", loginMechineName=" + loginMechineName + ", loginPort="
                + loginPort + ", loginDoor=" + loginDoor + "}";
    }
}
