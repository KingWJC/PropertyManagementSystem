...
public class FyMoneyTemporary03 implements Serializable {
    ...
    public String toString() {
        return "FyMoneyTemporary03{" + "id=" + id + ", moneySettingCode=" + moneySettingCode + ", recordName="
                + recordName + ", recordRemark=" + recordRemark + ", publicBoxName=" + publicBoxName + ", priceUnit="
                + priceUnit + ", shareNumber=" + shareNumber + ", lastReadNumber=" + lastReadNumber
                + ", currentReadNumber=" + currentReadNumber + ", currentUseNumber=" + currentUseNumber + ", shouldPay="
                + shouldPay + ", lastPayStopDate=" + lastPayStopDate + ", currentPayStartDate=" + currentPayStartDate
                + ", currentPayStopDate=" + currentPayStopDate + ", currentPayLimitDate=" + currentPayLimitDate
                + ", receiveCycle=" + receiveCycle + ", operatePerson=" + operatePerson + ", operateDate=" + operateDate
                + "}";
    }
}
