...
public class TblVoteProject1 implements Serializable {
    ...
    public String toString() {
        return "TblVoteProject1{" + "id=" + id + ", projectName=" + projectName + ", projectType=" + projectType
                + ", projectTag=" + projectTag + ", projectDesc=" + projectDesc + ", inputRecordPerson="
                + inputRecordPerson + ", inputRecordDate=" + inputRecordDate + "}";
    }
}
