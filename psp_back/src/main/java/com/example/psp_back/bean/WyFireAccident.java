...
public class WyFireAccident implements Serializable {
    ...
    public String toString() {
        return "WyFireAccident{" + "id=" + id + ", accidentDate=" + accidentDate + ", accidentPlace=" + accidentPlace
                + ", occurReason=" + occurReason + ", relatedPerson=" + relatedPerson + ", handleResult=" + handleResult
                + ", loss=" + loss + ", remark=" + remark + ", company=" + company + "}";
    }
}
