...
public class ZhRentTransfer implements Serializable {
    ...
    public String toString() {
        return "ZhRentTransfer{" + "id=" + id + ", contractId=" + contractId + ", transferOutId=" + transferOutId
                + ", transferOutName=" + transferOutName + ", transferInId=" + transferInId + ", transferInName="
                + transferInName + ", changeNameMoney=" + changeNameMoney + ", transferDesc=" + transferDesc
                + ", transferDate=" + transferDate + ", operatePerson=" + operatePerson + ", operateDate=" + operateDate
                + "}";
    }
}
