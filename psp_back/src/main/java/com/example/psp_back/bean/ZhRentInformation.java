...
public class ZhRentInformation implements Serializable {
    ...
    public String toString() {
        return "ZhRentInformation{" + "id=" + id + ", rentCode=" + rentCode + ", rentName=" + rentName
                + ", memberOfRight=" + memberOfRight + ", rentType=" + rentType + ", contact=" + contact + ", gender="
                + gender + ", homeNumber=" + homeNumber + ", phoneNumber=" + phoneNumber + ", addr=" + addr
                + ", certificateType=" + certificateType + ", mainSale=" + mainSale + ", certificateNumber="
                + certificateNumber + ", status=" + status + ", remark=" + remark + ", pictureUrl=" + pictureUrl
                + ", createPerson=" + createPerson + ", createDate=" + createDate + ", updatePerson=" + updatePerson
                + ", updateDate=" + updateDate + ", company=" + company + ", pwd=" + pwd + ", rentAttach=" + rentAttach
                + "}";
    }
}
