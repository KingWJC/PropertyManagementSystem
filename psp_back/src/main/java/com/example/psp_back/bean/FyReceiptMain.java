package com.example.psp_back.bean;
...
public class FyReceiptMain implements Serializable {
    ...
    public String toString() {
        return "FyReceiptMain{" + "id=" + id + ", cellId=" + cellId + ", receiveDate=" + receiveDate + ", customerName="
                + customerName + ", shouldPayTotal=" + shouldPayTotal + ", currentShouldReceive=" + currentShouldReceive
                + ", discountMoney=" + discountMoney + ", receiveMethod=" + receiveMethod + ", isCustomer=" + isCustomer
                + ", currentRealReceive=" + currentRealReceive + ", temporaryMoneyId=" + temporaryMoneyId
                + ", estateId=" + estateId + ", currentDelayMoney=" + currentDelayMoney + ", lastDelayMoney="
                + lastDelayMoney + ", title=" + title + ", receiveType=" + receiveType + ", receiptNumber="
                + receiptNumber + ", invoiceNumber=" + invoiceNumber + ", status=" + status + ", remark=" + remark
                + ", receivePerson=" + receivePerson + ", company=" + company + ", operateDate=" + operateDate
                + ", updatePerson=" + updatePerson + ", updateDate=" + updateDate + ", updateReason=" + updateReason
                + ", receiptCheckStatus=" + receiptCheckStatus + ", receiptCheckPerson=" + receiptCheckPerson
                + ", receiptCheckTime=" + receiptCheckTime + ", receiptCheckAdvice=" + receiptCheckAdvice
                + ", moneyCheckStatus=" + moneyCheckStatus + ", moneyCheckPerson=" + moneyCheckPerson
                + ", moneyCheckTime=" + moneyCheckTime + ", moneyCheckAdvice=" + moneyCheckAdvice + "}";
    }
}
