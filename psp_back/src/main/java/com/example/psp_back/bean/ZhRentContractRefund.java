...
public class ZhRentContractRefund implements Serializable {
    ...
    public String toString() {
        return "ZhRentContractRefund{" + "id=" + id + ", contractId=" + contractId + ", rentId=" + rentId
                + ", rentName=" + rentName + ", refundTime=" + refundTime + ", refundMoney=" + refundMoney
                + ", refundStatus=" + refundStatus + ", refundDesc=" + refundDesc + ", operateId=" + operateId
                + ", operatePerson=" + operatePerson + ", operateDate=" + operateDate + ", invalidId=" + invalidId
                + ", invalidPerson=" + invalidPerson + ", invalidReason=" + invalidReason + ", invalidDate="
                + invalidDate + "}";
    }
}
