...
public class WyCarSpaceRentDetail implements Serializable {
    ...
    public String toString() {
        return "WyCarSpaceRentDetail{" + "id=" + id + ", rentId=" + rentId + ", payType=" + payType + ", payStartDate="
                + payStartDate + ", payStopDate=" + payStopDate + ", shouldReceive=" + shouldReceive
                + ", discountMoney=" + discountMoney + ", delayMoney=" + delayMoney + ", realReceiveMoney="
                + realReceiveMoney + ", desc=" + desc + ", receiveId=" + receiveId + ", receivePersonName="
                + receivePersonName + ", receiveDate=" + receiveDate + ", invoiceNumber=" + invoiceNumber
                + ", receiveStatus=" + receiveStatus + ", invalidPersonId=" + invalidPersonId + ", invalidPersonName="
                + invalidPersonName + ", invalidReason=" + invalidReason + ", invalidDate=" + invalidDate
                ...
                + ", invalidCheckStatus=" + invalidCheckStatus + ", invalidCheckPerson=" + invalidCheckPerson
                + ", invalidCheckTime=" + invalidCheckTime + ", invalidCheckAdvice=" + invalidCheckAdvice + "}";
    }
}
