...
public class FcCell implements Serializable {
    ...
    public String toString() {
        return "FcCell{" + "id=" + id + ", unitCode=" + unitCode + ", cellCode=" + cellCode + ", cellName=" + cellName
                + ", cellHouseCode=" + cellHouseCode + ", cellTowardCode=" + cellTowardCode + ", cellFunction="
                + cellFunction + ", cellDecorateCode=" + cellDecorateCode + ", cellUsedArea=" + cellUsedArea
                + ", cellBuildArea=" + cellBuildArea + ", carportArea=" + carportArea + ", carArea=" + carArea
                + ", loftArea=" + loftArea + ", storeArea=" + storeArea + ", floorNumber=" + floorNumber + ", lastDebt="
                + lastDebt + ", propertyType=" + propertyType + ", rentMoney=" + rentMoney + ", length=" + length
                + ", width=" + width + ", stallUse=" + stallUse + ", stallArea=" + stallArea + ", isSale=" + isSale
                + ", isRent=" + isRent + ", saleContractId=" + saleContractId + ", rentContractId=" + rentContractId
                + ", remark=" + remark + ", factor=" + factor + ", cellProperty=" + cellProperty + ", storeId="
                + storeId + ", carLicenceId=" + carLicenceId + ", carSpaceId=" + carSpaceId + "}";
    }
}
