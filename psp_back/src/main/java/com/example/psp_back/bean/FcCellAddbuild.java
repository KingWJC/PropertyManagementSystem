...
public class FcCellAddbuild implements Serializable {
    ...
    public String toString() {
        return "FcCellAddbuild{" + "id=" + id + ", cellId=" + cellId + ", addbuildArea=" + addbuildArea
                + ", addbuildTime=" + addbuildTime + ", addbuildState=" + addbuildState + ", addbuildDesc="
                + addbuildDesc + ", addbuildAccessory=" + addbuildAccessory + ", operatePerson=" + operatePerson
