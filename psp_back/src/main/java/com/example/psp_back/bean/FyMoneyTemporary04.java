...
public class FyMoneyTemporary04 implements Serializable {
    ...
    public String toString() {
        return "FyMoneyTemporary04{" + "id=" + id + ", moneySettingCode=" + moneySettingCode + ", cellId=" + cellId
                + ", estateName=" + estateName + ", buildingName=" + buildingName + ", unitName=" + unitName
                + ", cellName=" + cellName + ", customerName=" + customerName + ", boxId=" + boxId + ", shareMoney="
                + shareMoney + ", currentShareNumber=" + currentShareNumber + ", priceUnit=" + priceUnit
                + ", currentPayStartDate=" + currentPayStartDate + ", currentPayStopDate=" + currentPayStopDate
                + ", currentPayLimitDate=" + currentPayLimitDate + ", receiveCycle=" + receiveCycle
                + ", primaryIdentify=" + primaryIdentify + ", operatePerson=" + operatePerson + ", operateDate="
                + operateDate + "}";
    }
}
