...
public class FyShareStandingBookDetail implements Serializable {
    ...
    public String toString() {
        return "FyShareStandingBookDetail{" + "id=" + id + ", standingBookId=" + standingBookId + ", publicBoxName="
                + publicBoxName + ", priceUnit=" + priceUnit + ", shareNumber=" + shareNumber + ", lastReadNumber="
                + lastReadNumber + ", currentReadNumber=" + currentReadNumber + ", currentUseNumber=" + currentUseNumber
                ...
                + currentPayLimitDate + ", receiveCycle=" + receiveCycle + "}";
    }
}
