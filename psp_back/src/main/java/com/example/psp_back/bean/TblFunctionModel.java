...
public class TblFunctionModel implements Serializable {
    ...
    public String toString() {
        return "TblFunctionModel{" + "id=" + id + ", modelName=" + modelName + ", modelType=" + modelType
                + ", modelParent=" + modelParent + ", modelStatus=" + modelStatus + ", modelUrl=" + modelUrl
                + ", modelAnalyseRef=" + modelAnalyseRef + ", modelReportAnalyse=" + modelReportAnalyse + ", modelIcon="
                + modelIcon + ", modelProperty=" + modelProperty + ", modelDesc=" + modelDesc + ", isControl="
                + isControl + ", mFull=" + mFull + ", mAdd=" + mAdd + ", mMod=" + mMod + ", mDel=" + mDel + ", mExp="
                + mExp + ", mAud=" + mAud + ", mExe=" + mExe + ", mQue=" + mQue + ", dPerson=" + dPerson + ", dDept="
                + dDept + ", dCompany=" + dCompany + ", orderid=" + orderid + ", createPerson=" + createPerson
