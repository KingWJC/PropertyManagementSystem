...
public class ZhCustomer implements Serializable {
    ...
    public String toString() {
        return "ZhCustomer{" + "id=" + id + ", customerCode=" + customerCode + ", customerPwd=" + customerPwd
                + ", customerName=" + customerName + ", customerBirthday=" + customerBirthday + ", customerGender="
                + customerGender + ", openBank=" + openBank + ", nationality=" + nationality + ", bankAccount="
                + bankAccount + ", education=" + education + ", certificateNumber=" + certificateNumber
                + ", certificateType=" + certificateType + ", workPlace=" + workPlace + ", customerDuty=" + customerDuty
                + ", police=" + police + ", nation=" + nation + ", phoneNumber=" + phoneNumber + ", nativePlace="
                + nativePlace + ", address=" + address + ", postCode=" + postCode + ", urgencyUserName="
                + urgencyUserName + ", urgencyUserPhone=" + urgencyUserPhone + ", urgencyUserAddress="
                + urgencyUserAddress + ", customerStatus=" + customerStatus + ", customerType=" + customerType
                + ", picture=" + picture + ", remark=" + remark + ", createPerson=" + createPerson + ", createDate="
                + createDate + ", updatePerson=" + updatePerson + ", updateDate=" + updateDate + ", company=" + company
