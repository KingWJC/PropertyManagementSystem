...
public class ZhCsHandleResult implements Serializable {
    ...
    public String toString() {
        return "ZhCsHandleResult{" + "id=" + id + ", serviceId=" + serviceId + ", transactorId=" + transactorId
                + ", transactorName=" + transactorName + ", isLeader=" + isLeader + ", relationCompany="
                + relationCompany + ", phoneNumber=" + phoneNumber + ", handleStartDate=" + handleStartDate
                + ", handleStopDate=" + handleStopDate + ", handleResult=" + handleResult + ", handleFinishAttach="
                + handleFinishAttach + "}";
    }
}
