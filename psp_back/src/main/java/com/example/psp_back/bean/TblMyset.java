...
public class TblMyset implements Serializable {
    ...
    public String toString() {
        return "TblMyset{" + "id=" + id + ", username=" + username + ", idRemain=" + idRemain + ", remainInterval="
                + remainInterval + ", remainWindowOpen=" + remainWindowOpen + ", messageRemain=" + messageRemain
                + ", defaultMain=" + defaultMain + ", emailAll=" + emailAll + ", smtpAddr=" + smtpAddr + ", loginUser="
                + loginUser + ", loginPwd=" + loginPwd + ", mailPort=" + mailPort + ", sendPerson=" + sendPerson
                + ", pageCount=" + pageCount + "}";
    }
}
