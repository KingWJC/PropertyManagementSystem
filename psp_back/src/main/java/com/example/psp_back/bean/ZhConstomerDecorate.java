...
public class ZhConstomerDecorate implements Serializable {
    ...
    public String toString() {
        return "ZhConstomerDecorate{" + "id=" + id + ", cellId=" + cellId + ", proposer=" + proposer + ", phoneNumber="
                + phoneNumber + ", proposerDate=" + proposerDate + ", decorateContent=" + decorateContent
                + ", checkPerson=" + checkPerson + ", decorateEnsureMoney=" + decorateEnsureMoney + ", checkDate="
                + checkDate + ", checkAdvice=" + checkAdvice + ", leaderPhone=" + leaderPhone + ", executeCompany="
                + executeCompany + ", executeStartDate=" + executeStartDate + ", leader=" + leader + ", checkedPerson="
                + checkedPerson + ", executeStopDate=" + executeStopDate + ", checkedAdvice=" + checkedAdvice
                + ", checkedDate=" + checkedDate + ", remark=" + remark + ", status=" + status + ", createPerson="
                + createPerson + ", createDate=" + createDate + ", identify=" + identify + ", confirmPerson="
                + confirmPerson + ", confirmDate=" + confirmDate + ", decorateAttach=" + decorateAttach
