...
public class FyReceiptSub implements Serializable {
    ...
    public String toString() {
        return "FyReceiptSub{" + "receiptDetailId=" + receiptDetailId + ", receiptId=" + receiptId
                + ", moneySettingName=" + moneySettingName + ", chargeUnit=" + chargeUnit + ", lastReadNumber="
                + lastReadNumber + ", currentReadNumber=" + currentReadNumber + ", realUsed=" + realUsed + ", money="
                + money + ", delayMoney=" + delayMoney + ", delayDerateMoney=" + delayDerateMoney
                + ", currentShouldPay=" + currentShouldPay + ", overDay=" + overDay + ", moneyStartDate="
                + moneyStartDate + ", moneyStopDate=" + moneyStopDate + ", payLimitDay=" + payLimitDay
                + ", floorFactor=" + floorFactor + ", inputPerson=" + inputPerson + ", standingBookId=" + standingBookId
                + ", receiveCycle=" + receiveCycle + ", derateMoney=" + derateMoney + ", moneyId=" + moneyId
                + ", updateReason=" + updateReason + ", updatePerson=" + updatePerson + ", updateDate=" + updateDate
                + ", moneyMult=" + moneyMult + "}";
    }
}
