...
public class TblSendLog implements Serializable {
    ...
    public String toString() {
        return "TblSendLog{" + "id=" + id + ", sendName=" + sendName + ", requestDate=" + requestDate + ", sendTag="
                + sendTag + ", timingDate=" + timingDate + ", messageType=" + messageType + ", extendPhone="
                + extendPhone + ", receivePhone=" + receivePhone + ", messageContent=" + messageContent + ", isSend="
                + isSend + ", receiveIdentify=" + receiveIdentify + "}";
    }
}
