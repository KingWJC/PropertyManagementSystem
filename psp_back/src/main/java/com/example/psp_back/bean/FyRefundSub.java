...
public class FyRefundSub implements Serializable {
    ...
    public String toString() {
        return "FyRefundSub{" + "id=" + id + ", refundId=" + refundId + ", moneySettingName=" + moneySettingName
                + ", chargeUnit=" + chargeUnit + ", lastReadNumber=" + lastReadNumber + ", currentReadNumber="
                + currentReadNumber + ", realUsed=" + realUsed + ", money=" + money + ", delayMoney=" + delayMoney
                ...
                + ", inputPerson=" + inputPerson + ", standingBookId=" + standingBookId + ", receiveCycle="
                + receiveCycle + ", moneyDerate=" + moneyDerate + ", moneyId=" + moneyId + ", delayDerateMoney="
                + delayDerateMoney + ", moneyMult=" + moneyMult + ", floorFactor=" + floorFactor + "}";
    }
}
