...
public class FyPropertyMoneyDist implements Serializable {
    ...
    public String toString() {
        return "FyPropertyMoneyDist{" + "id=" + id + ", cellId=" + cellId + ", moneyId=" + moneyId + ", isPublicMoney="
                + isPublicMoney + ", currentReadNumber=" + currentReadNumber + ", lastChargeUnit=" + lastChargeUnit
                + ", floorFactor=" + floorFactor + ", useNumberMult=" + useNumberMult + "}";
    }
}
