...
public class FcUnit implements Serializable {
    ...
    public String toString() {
        return "FcUnit{" + "id=" + id + ", buildingCode=" + buildingCode + ", unitCode=" + unitCode + ", unitName="
                + unitName + ", startFloor=" + startFloor + ", stopFloor=" + stopFloor + ", startCellId=" + startCellId
                + ", stopCellId=" + stopCellId + ", remark=" + remark + "}";
    }
}
