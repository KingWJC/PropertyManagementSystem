...
public class TblMyplan implements Serializable {
    ...
    public String toString() {
        return "TblMyplan{" + "id=" + id + ", planTheme=" + planTheme + ", planAddr=" + planAddr + ", startDate="
                + startDate + ", stopDate=" + stopDate + ", planType=" + planType + ", planStatus=" + planStatus
                + ", planPrior=" + planPrior + ", fieldBak=" + fieldBak + ", planDesc=" + planDesc + ", attachName="
                + attachName + ", attachUrl=" + attachUrl + ", owner=" + owner + ", createDate=" + createDate
