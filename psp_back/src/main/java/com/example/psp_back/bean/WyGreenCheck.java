...
public class WyGreenCheck implements Serializable {
    ...
    public String toString() {
        return "WyGreenCheck{" + "id=" + id + ", greenCode=" + greenCode + ", checkDate=" + checkDate
                + ", checkCondition=" + checkCondition + ", handleCondition=" + handleCondition + ", checkPerson="
                + checkPerson + ", remark=" + remark + ", company=" + company + "}";
    }
}
