...
public class TblEmailSend implements Serializable {
    ...
    public String toString() {
        return "TblEmailSend{" + "id=" + id + ", receivePersonCode=" + receivePersonCode + ", receivePersonName="
                + receivePersonName + ", emailTitle=" + emailTitle + ", emailContent=" + emailContent
                + ", importantGrade=" + importantGrade + ", isDraft=" + isDraft + ", isDelete=" + isDelete
