...
public class WyFireExercise implements Serializable {
    ...
    public String toString() {
        return "WyFireExercise{" + "id=" + id + ", unit=" + unit + ", startDate=" + startDate + ", stopDate=" + stopDate
                + ", exercisePurpose=" + exercisePurpose + ", joinPersons=" + joinPersons + ", assistantUnit="
                + assistantUnit + ", exerciseContent=" + exerciseContent + ", exerciseResult=" + exerciseResult
                + ", remark=" + remark + ", company=" + company + "}";
    }
}
