...
public class TblComparyNotice implements Serializable {
    ...
    public String toString() {
        return "TblComparyNotice{" + "id=" + id + ", noticeTheme=" + noticeTheme + ", noticeContent=" + noticeContent
                + ", startDate=" + startDate + ", stopDate=" + stopDate + ", receiveType=" + receiveType
                + ", noticeCategory=" + noticeCategory + ", attachName=" + attachName + ", attachPath=" + attachPath
                + ", status=" + status + ", noticeType=" + noticeType + ", noticeAttach=" + noticeAttach
                + ", inputPerson=" + inputPerson + ", inputDate=" + inputDate + ", checkPerson=" + checkPerson
                + ", checkDate=" + checkDate + ", checkAdvice=" + checkAdvice + ", allowUserCode=" + allowUserCode
