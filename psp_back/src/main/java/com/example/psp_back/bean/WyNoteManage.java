...
public class WyNoteManage implements Serializable {
    ...
    public String toString() {
        return "WyNoteManage{" + "noteId=" + noteId + ", notePrefix=" + notePrefix + ", noteSerialNumber="
                + noteSerialNumber + ", noteStatus=" + noteStatus + ", noteDesc=" + noteDesc + ", userId=" + userId
                + ", userName=" + userName + ", createPerson=" + createPerson + ", createDate=" + createDate
                + ", updatePerson=" + updatePerson + ", updateDate=" + updateDate + ", assignPersonId=" + assignPersonId
                + ", assignPersonName=" + assignPersonName + ", assignDate=" + assignDate + ", printPersonId="
                + printPersonId + ", printPersonName=" + printPersonName + ", printDate=" + printDate + ", noteType="
                + noteType + ", receiveMoneyId=" + receiveMoneyId + ", invalidReason=" + invalidReason
                + ", invalidPersonId=" + invalidPersonId + ", invalidPersonName=" + invalidPersonName + ", invalidDate="
                + invalidDate + ", invalidConfirmPerson=" + invalidConfirmPerson + ", invalidConfirmDate="
                + invalidConfirmDate + "}";
    }
}
