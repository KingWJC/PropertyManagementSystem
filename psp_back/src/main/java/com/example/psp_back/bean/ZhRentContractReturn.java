...
public class ZhRentContractReturn implements Serializable {
    ...
    public String toString() {
        return "ZhRentContractReturn{" + "id=" + id + ", contractId=" + contractId + ", rentId=" + rentId
                + ", rentName=" + rentName + ", returnMoneyStart=" + returnMoneyStart + ", returnMoneyStop="
                + returnMoneyStop + ", returnCardinalMoney=" + returnCardinalMoney + ", returnRate=" + returnRate
                + ", currentReturnMoney=" + currentReturnMoney + ", returnMoneyStatus=" + returnMoneyStatus
                + ", returnMoneyDesc=" + returnMoneyDesc + ", operateId=" + operateId + ", operateName=" + operateName
                + ", operateDate=" + operateDate + ", invalidId=" + invalidId + ", invalidPerson=" + invalidPerson
                + ", invalidDate=" + invalidDate + ", invalidReason=" + invalidReason + ", updatePersonId="
                + updatePersonId + ", updatePersonName=" + updatePersonName + ", updateDate=" + updateDate
