...
public class FyInvalidSub implements Serializable {
    ...
    public String toString() {
        return "FyInvalidSub{" + "invalidDetailId=" + invalidDetailId + ", invalidId=" + invalidId
                ...
                + money + ", delayMoney=" + delayMoney + ", currentShouldPay=" + currentShouldPay + ", overDay="
                + overDay + ", moneyStartDate=" + moneyStartDate + ", moneyStopDate=" + moneyStopDate + ", payLimitDay="
                + payLimitDay + ", inputPerson=" + inputPerson + ", standingBookId=" + standingBookId
                + ", receiveCycle=" + receiveCycle + ", derateMoney=" + derateMoney + ", moneyId=" + moneyId
                + ", delayDerateMoney=" + delayDerateMoney + ", mopFloor=" + mopFloor + ", moneyMult=" + moneyMult
                + "}";
    }
}
