...
public class FyShareUserDetail implements Serializable {
    ...
    public String toString() {
        return "FyShareUserDetail{" + "id=" + id + ", standingBookId=" + standingBookId + ", cellId=" + cellId
                + ", customerName=" + customerName + ", boxId=" + boxId + ", shareMoney=" + shareMoney
                + ", currentShareNumber=" + currentShareNumber + ", currentPayStartDate=" + currentPayStartDate
                + ", currentPayStopDate=" + currentPayStopDate + ", currentPayLimitDate=" + currentPayLimitDate
                + ", receiveIdentify=" + receiveIdentify + ", priceUnit=" + priceUnit + ", costIdentify=" + costIdentify
                + ", receiveId=" + receiveId + ", refundNumber=" + refundNumber + ", receiveCycle=" + receiveCycle
                + ", derateMoney=" + derateMoney + ", shouldPay=" + shouldPay + ", invalidNumber=" + invalidNumber
