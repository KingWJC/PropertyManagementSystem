...
public class WyGreenSetting implements Serializable {
    ...
    public String toString() {
        return "WyGreenSetting{" + "settingCode=" + settingCode + ", settingName=" + settingName + ", area=" + area
                + ", greenDate=" + greenDate + ", greenPlace=" + greenPlace + ", leader=" + leader + ", mainVegetation="
                + mainVegetation + ", remark=" + remark + ", company=" + company + "}";
    }
}
