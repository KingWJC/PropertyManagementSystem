...
public class TblEmailReceive implements Serializable {
    ...
    public String toString() {
        return "TblEmailReceive{" + "id=" + id + ", emailSendId=" + emailSendId + ", receiveId=" + receiveId
                + ", receivePersonCode=" + receivePersonCode + ", receivePersonName=" + receivePersonName
                + ", emailTitle=" + emailTitle + ", emailContent=" + emailContent + ", importantGrade=" + importantGrade
                + ", status=" + status + ", isDelete=" + isDelete + ", isSecretSend=" + isSecretSend + ", emailAttach="
                + emailAttach + ", receiveType=" + receiveType + ", sendPersonId=" + sendPersonId + ", sendPersonName="
                + sendPersonName + ", sendDate=" + sendDate + ", receiveDate=" + receiveDate + "}";
    }
}
