...
public class TblGroupRecord implements Serializable {
    ...
    public String toString() {
        return "TblGroupRecord{" + "groupRecordId=" + groupRecordId + ", groupName=" + groupName + ", groupType="
                + groupType + ", groupDesc=" + groupDesc + ", groupMemberId=" + groupMemberId + ", groupMemberName="
                + groupMemberName + ", createPerson=" + createPerson + ", createDate=" + createDate + "}";
    }
}
