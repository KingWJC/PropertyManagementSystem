...
public class WyOutProject implements Serializable {
    ...
    public String toString() {
        return "WyOutProject{" + "id=" + id + ", outProjectName=" + outProjectName + ", parentOutProjectId="
                + parentOutProjectId + ", desc=" + desc + ", createPerson=" + createPerson + ", createDate="
                + createDate + ", updatePerson=" + updatePerson + ", updateDate=" + updateDate + "}";
    }
}
