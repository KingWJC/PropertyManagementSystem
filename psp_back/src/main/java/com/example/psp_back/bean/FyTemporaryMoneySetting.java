...
public class FyTemporaryMoneySetting implements Serializable {
    ...
    public String toString() {
        return "FyTemporaryMoneySetting{" + "id=" + id + ", temporaryMoneyName=" + temporaryMoneyName
                + ", upperMoneyId=" + upperMoneyId + ", priceUnit=" + priceUnit + ", moneyDescription="
                + moneyDescription + ", createPerson=" + createPerson + ", createDate=" + createDate + ", updatePerson="
                + updatePerson + ", updateDate=" + updateDate + ", company=" + company + "}";
    }
}
