...
public class WyCarSpaceRent implements Serializable {
    ...
    public String toString() {
        return "WyCarSpaceRent{" + "id=" + id + ", constractId=" + constractId + ", carSpaceId=" + carSpaceId
                + ", rentStartDate=" + rentStartDate + ", rentStopDate=" + rentStopDate + ", rentMonth=" + rentMonth
                + ", userId=" + userId + ", userName=" + userName + ", carLicenceId=" + carLicenceId
                + ", stopCarLicence=" + stopCarLicence + ", rentPerMonth=" + rentPerMonth + ", serviceMoneyPerMonth="
                + serviceMoneyPerMonth + ", signDate=" + signDate + ", startDate=" + startDate + ", stopDate="
                + stopDate + ", status=" + status + ", remark=" + remark + ", agentMoney=" + agentMoney
                + ", isRentMoney=" + isRentMoney + ", contractAttach=" + contractAttach + ", createPerson="
                + createPerson + ", createDate=" + createDate + ", updatePerson=" + updatePerson + ", updateDate="
                + updateDate + "}";
    }
}
