...
public class FyMoneyTemporary01 implements Serializable {
    ...
    public String toString() {
        return "FyMoneyTemporary01{" + "id=" + id + ", moneyId=" + moneyId + ", recordName=" + recordName
                + ", recordRemark=" + recordRemark + ", cellId=" + cellId + ", estateName=" + estateName
                + ", buildingName=" + buildingName + ", unitName=" + unitName + ", cellName=" + cellName
                + ", customerName=" + customerName + ", boxId=" + boxId + ", priceUnit=" + priceUnit
                + ", lastReadNumber=" + lastReadNumber + ", currentReadNumber=" + currentReadNumber
                + ", currentUseNumber=" + currentUseNumber + ", shouldPay=" + shouldPay + ", lastPayStopDate="
                + lastPayStopDate + ", currentPayStartDate=" + currentPayStartDate + ", currentPayStopDate="
                + currentPayStopDate + ", currentPayLimitDate=" + currentPayLimitDate + ", receiveCycle=" + receiveCycle
                + ", operatePerson=" + operatePerson + ", operateDate=" + operateDate + ", floorFactor=" + floorFactor
                + ", moneyMult=" + moneyMult + "}";
    }
}
