...
public class FyMoneySetting implements Serializable {
    ...
    public String toString() {
        return "FyMoneySetting{" + "id=" + id + ", moneySettingCode=" + moneySettingCode + ", moneySettingName="
                + moneySettingName + ", receiveType=" + receiveType + ", priceUnit=" + priceUnit + ", receiveCycle="
                + receiveCycle + ", moneyType=" + moneyType + ", isUpdatePrice=" + isUpdatePrice
                + ", isConvenientMoney=" + isConvenientMoney + ", minUsedNumber=" + minUsedNumber + ", isStepReceive="
                + isStepReceive + ", stepCondition1=" + stepCondition1 + ", stepPrice1=" + stepPrice1
                + ", stepCondition21=" + stepCondition21 + ", stepCondition22=" + stepCondition22 + ", stepPrice2="
                + stepPrice2 + ", stepCondition31=" + stepCondition31 + ", stepCondition32=" + stepCondition32
                + ", stepPrice3=" + stepPrice3 + ", stepCondition41=" + stepCondition41 + ", stepCondition42="
                + stepCondition42 + ", stepPrice4=" + stepPrice4 + ", stepCondition5=" + stepCondition5
                + ", stepPrice5=" + stepPrice5 + ", renewMessage=" + renewMessage + ", receiveWarnStopDay="
                + receiveWarnStopDay + ", maxWarnNumber=" + maxWarnNumber + ", askMessage=" + askMessage
                + ", noReceiveWarnStopDay=" + noReceiveWarnStopDay + ", associateMoneyId=" + associateMoneyId
                + ", delayRate=" + delayRate + ", delayOverDay=" + delayOverDay + ", company=" + company
