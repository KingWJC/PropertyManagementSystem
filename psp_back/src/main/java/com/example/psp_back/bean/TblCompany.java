...
public class TblCompany implements Serializable {
    ...
    public String toString() {
        return "TblCompany{" + "id=" + id + ", companyFullName=" + companyFullName + ", companySimpleName="
                + companySimpleName + ", companyEnglishName=" + companyEnglishName + ", companyBrand=" + companyBrand
                + ", companyType=" + companyType + ", companyTrade=" + companyTrade + ", companyAddr=" + companyAddr
                + ", postCode=" + postCode + ", companyPhone=" + companyPhone + ", companyFax=" + companyFax
                + ", companyWebsite=" + companyWebsite + ", companyEmail=" + companyEmail + ", companyNational="
                + companyNational + ", companyLand=" + companyLand + ", openBank=" + openBank + ", bankAccount="
                + bankAccount + ", companyLeader=" + companyLeader + ", registerDate=" + registerDate
                + ", registerMoney=" + registerMoney + ", employeeNumber=" + employeeNumber + ", companyIntro="
                + companyIntro + ", remark=" + remark + "}";
    }
}
