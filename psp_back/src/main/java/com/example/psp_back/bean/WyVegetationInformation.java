...
public class WyVegetationInformation implements Serializable {
    ...
    public String toString() {
        return "WyVegetationInformation{" + "vegetationId=" + vegetationId + ", vegetationName=" + vegetationName
                + ", vegetationType=" + vegetationType + ", vegetationAge=" + vegetationAge + ", vegetationNumber="
                + vegetationNumber + ", vegetationUnit=" + vegetationUnit + ", vegetationHabit=" + vegetationHabit
                + ", vegetationFeature=" + vegetationFeature + ", remark=" + remark + ", company=" + company + "}";
    }
}
