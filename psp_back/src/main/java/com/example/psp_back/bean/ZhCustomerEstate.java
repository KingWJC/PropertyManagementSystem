...
public class ZhCustomerEstate implements Serializable {
    ...
    public String toString() {
        return "ZhCustomerEstate{" + "id=" + id + ", customerId=" + customerId + ", customerName=" + customerName
                + ", cellId=" + cellId + ", useStatus=" + useStatus + ", liveDate=" + liveDate + ", decorateDate="
                + decorateDate + ", subscriptionCardNumber=" + subscriptionCardNumber + ", houseCode=" + houseCode
                + ", isPayDecorateMoney=" + isPayDecorateMoney + ", prePayDecorateMoney=" + prePayDecorateMoney
