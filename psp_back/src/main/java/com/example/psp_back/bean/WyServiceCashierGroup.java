...
public class WyServiceCashierGroup implements Serializable {
    ...
    public String toString() {
        return "WyServiceCashierGroup{" + "id=" + id + ", name=" + name + ", includeBuildingCode=" + includeBuildingCode
                + ", includeBuildingName=" + includeBuildingName + ", includeServiceCode=" + includeServiceCode
                + ", includeServiceName=" + includeServiceName + ", desc=" + desc + ", company=" + company
