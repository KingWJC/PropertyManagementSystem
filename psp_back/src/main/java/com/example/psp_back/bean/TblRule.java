...
public class TblRule implements Serializable {
    ...
    public String toString() {
        return "TblRule{" + "id=" + id + ", title=" + title + ", content=" + content + ", useRange=" + useRange
                + ", category=" + category + ", articleNumber=" + articleNumber + ", level=" + level + ", secretLevel="
                + secretLevel + ", titleWord=" + titleWord + ", publishCompany=" + publishCompany + ", attachName="
                + attachName + ", attachPath=" + attachPath + ", status=" + status + ", createPerson=" + createPerson
                + ", createDate=" + createDate + ", checkPerson=" + checkPerson + ", checkDate=" + checkDate
                + ", checkAdvice=" + checkAdvice + ", allowUserCode=" + allowUserCode + ", allowUserName="
                + allowUserName + ", ruleAttach=" + ruleAttach + "}";
    }
}
