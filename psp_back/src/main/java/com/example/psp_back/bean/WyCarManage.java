...
public class WyCarManage implements Serializable {
    ...
    public String toString() {
        return "WyCarManage{" + "id=" + id + ", carLicnece=" + carLicnece + ", stopCarLicence=" + stopCarLicence
                + ", carOwnerName=" + carOwnerName + ", carport=" + carport + ", inDate=" + inDate + ", outDate="
                + outDate + ", agent=" + agent + ", remark=" + remark + ", company=" + company + "}";
    }
}
