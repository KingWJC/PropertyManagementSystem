...
public class WyCarSpaceManage implements Serializable {
    ...
    public String toString() {
        return "WyCarSpaceManage{" + "id=" + id + ", carSpaceType=" + carSpaceType + ", carLicenceId=" + carLicenceId
                + ", preSalePrice=" + preSalePrice + ", preRentPrice=" + preRentPrice + ", stopCarLicence="
                + stopCarLicence + ", estateId=" + estateId + ", manageType=" + manageType + ", carSapcePosition="
                + carSapcePosition + ", carSapceArea=" + carSapceArea + ", ownerId=" + ownerId + ", ownerName="
                + ownerName + ", realSalePrice=" + realSalePrice + ", carSpaceCategory=" + carSpaceCategory
                + ", status=" + status + ", remark=" + remark + ", createPerson=" + createPerson + ", createDate="
                + createDate + ", updatePerson=" + updatePerson + ", updateDate=" + updateDate + ", salePerson="
                + salePerson + ", saleDate=" + saleDate + "}";
    }
}
