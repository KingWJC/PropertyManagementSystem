...
public class ZhConsumerComplain implements Serializable {
    ...
    public String toString() {
        return "ZhConsumerComplain{" + "id=" + id + ", cellId=" + cellId + ", complainPerson=" + complainPerson
                + ", complainPhone=" + complainPhone + ", complainDate=" + complainDate + ", phoneNumber=" + phoneNumber
                + ", receptionPerson=" + receptionPerson + ", complainType=" + complainType + ", status=" + status
                + ", startAcceptPerson=" + startAcceptPerson + ", startAcceptDate=" + startAcceptDate
                + ", acceptResult=" + acceptResult + ", acceptFinishPerson=" + acceptFinishPerson
                + ", acceptFinishDate=" + acceptFinishDate + ", datasource=" + datasource + ", referAttach="
                + referAttach + ", returnVisitPerson=" + returnVisitPerson + ", returnVisitDate=" + returnVisitDate
                + ", isSatisfy=" + isSatisfy + ", customerEvaluate=" + customerEvaluate + ", createPerson="
                + createPerson + ", createDate=" + createDate + "}";
    }
}
