...
public class ZhRentShare implements Serializable {
    ...
    public String toString() {
        return "ZhRentShare{" + "id=" + id + ", contractId=" + contractId + ", rentName=" + rentName
                + ", shareRentPerson=" + shareRentPerson + ", shareCellId=" + shareCellId + ", shareCellName="
                + shareCellName + ", contact=" + contact + ", phoneNumber=" + phoneNumber + ", startDate=" + startDate
                + ", stopDate=" + stopDate + ", saleRange=" + saleRange + ", remark=" + remark + ", operateId="
                + operateId + ", operatePerson=" + operatePerson + ", operateDate=" + operateDate + ", updatePersonId="
