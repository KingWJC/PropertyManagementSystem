...
public class FySaleContract implements Serializable {
    ...
    public String toString() {
        return "FySaleContract{" + "saleContractId=" + saleContractId + ", cellId=" + cellId + ", contractMoney="
                + contractMoney + ", contractDate=" + contractDate + ", payMethod=" + payMethod + ", idNumber="
                + idNumber + ", customerName=" + customerName + ", onlinePhone=" + onlinePhone + ", phoneNumber="
                + phoneNumber + ", remark=" + remark + ", contractAttach=" + contractAttach + "}";
    }
}
