...
public class FyStandingBookDetail implements Serializable {
    ...
    public String toString() {
        return "FyStandingBookDetail{" + "id=" + id + ", standingBookId=" + standingBookId + ", cellId=" + cellId
                + ", customerName=" + customerName + ", boxId=" + boxId + ", chargeUnit=" + chargeUnit + ", priceUnit="
                + priceUnit + ", lastReadNumber=" + lastReadNumber + ", currentReadNumber=" + currentReadNumber
                + ", currentUseNumber=" + currentUseNumber + ", shouldPay=" + shouldPay + ", lastPayStopDate="
                + lastPayStopDate + ", lastPayStartDate=" + lastPayStartDate + ", currentPayStopDate="
                + currentPayStopDate + ", currentPayLimitDate=" + currentPayLimitDate + ", costIdentify=" + costIdentify
                + ", receiveIdentify=" + receiveIdentify + ", receiveId=" + receiveId + ", refundNumber=" + refundNumber
                + ", receiveCycle=" + receiveCycle + ", derateMoney=" + derateMoney + ", shouldReceive=" + shouldReceive
                + ", invalidNumber=" + invalidNumber + ", floorFactor=" + floorFactor + ", derateDelayMoney="
                + derateDelayMoney + ", payMult=" + payMult + "}";
    }
}
