...
public class TblMessageReceive implements Serializable {
    ...
    public String toString() {
        return "TblMessageReceive{" + "id=" + id + ", phone=" + phone + ", extendPhone=" + extendPhone
                + ", messageContent=" + messageContent + ", replyDate=" + replyDate + ", positionOrder=" + positionOrder
                + ", receiveDate=" + receiveDate + ", readTag=" + readTag + ", readDate=" + readDate + "}";
    }
}
