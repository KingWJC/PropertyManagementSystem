...
public class FyRefundMain implements Serializable {
    ...
    public String toString() {
        return "FyRefundMain{" + "refundId=" + refundId + ", receiptId=" + receiptId + ", cellId=" + cellId
                + ", receiveCycle=" + receiveCycle + ", customerName=" + customerName + ", money=" + money
                + ", realReceiveMoney=" + realReceiveMoney + ", discountMoney=" + discountMoney + ", receiveMethod="
                + receiveMethod + ", isCustomer=" + isCustomer + ", receiveMoney=" + receiveMoney + ", moneyId="
                + moneyId + ", estateId=" + estateId + ", currentDelayMoney=" + currentDelayMoney + ", lastDelayMoney="
                + lastDelayMoney + ", refundType=" + refundType + ", receiptNumber=" + receiptNumber
                + ", invoiceNumber=" + invoiceNumber + ", receivePerson=" + receivePerson + ", remark=" + remark
                + ", company=" + company + ", refundReason=" + refundReason + ", refundTime=" + refundTime
                + ", refundPerson=" + refundPerson + ", checkStatus=" + checkStatus + ", checkPerson=" + checkPerson
                + ", checkTime=" + checkTime + ", checkAdvice=" + checkAdvice + "}";
    }
}
