...
public class ZhCustomerService implements Serializable {
    ...
    public String toString() {
        return "ZhCustomerService{" + "id=" + id + ", cellId=" + cellId + ", proposer=" + proposer + ", phoneNumber="
                + phoneNumber + ", appealDate=" + appealDate + ", appealEvent=" + appealEvent + ", status=" + status
                + ", serviceType=" + serviceType + ", createPerson=" + createPerson + ", createDate=" + createDate
                + ", identify=" + identify + ", checkPerson=" + checkPerson + ", checkDate=" + checkDate
                + ", checkAdvice=" + checkAdvice + ", serviceMoney=" + serviceMoney + ", returnVisitPerson="
                + returnVisitPerson + ", returnVisitDate=" + returnVisitDate + ", isSatisfy=" + isSatisfy
                + ", customerEvaluate=" + customerEvaluate + ", referAttach=" + referAttach + "}";
    }
}
