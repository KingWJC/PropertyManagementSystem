...
public class TblSysDiagrams implements Serializable {
    ...
    public String toString() {
        return "TblSysDiagrams{" + "diagramName=" + diagramName + ", belongPerson=" + belongPerson + ", diagramId="
                + diagramId + ", diagramVersion=" + diagramVersion + ", diagramDefinition=" + diagramDefinition + "}";
    }
}
