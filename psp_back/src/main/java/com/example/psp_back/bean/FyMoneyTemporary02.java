...
public class FyMoneyTemporary02 implements Serializable {
    ...
    public String toString() {
        return "FyMoneyTemporary02{" + "id=" + id + ", moneyId=" + moneyId + ", recordName=" + recordName
                ...
                + ", customerName=" + customerName + ", chargeUnit=" + chargeUnit + ", priceUnit=" + priceUnit
                + ", shouldPay=" + shouldPay + ", lastPayStopDate=" + lastPayStopDate + ", currentPayStartDate="
                + currentPayStartDate + ", currentPayStopDate=" + currentPayStopDate + ", currentPayLimitDate="
                + currentPayLimitDate + ", receiveCycle=" + receiveCycle + ", operatePerson=" + operatePerson
                + ", operateDate=" + operateDate + ", floorFactor=" + floorFactor + "}";
    }
}
