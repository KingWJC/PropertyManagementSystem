...
public class WyPropertyTakeoverDetail implements Serializable {
    ...
    public String toString() {
        return "WyPropertyTakeoverDetail{" + "id=" + id + ", takeoverId=" + takeoverId + ", projectName=" + projectName
                + ", checked=" + checked + ", checkedDate=" + checkedDate + ", checkedResult=" + checkedResult
                + ", finishDate=" + finishDate + ", finishCondition=" + finishCondition + ", remark=" + remark + "}";
    }
}
