...
public class FyHistoryMoneyTemp implements Serializable {
    ...
    public String toString() {
        return "FyHistoryMoneyTemp{" + "cellId=" + cellId + ", cellName=" + cellName + ", buildArea=" + buildArea
                + ", priceUnit=" + priceUnit + ", money=" + money + ", moneyStartDate=" + moneyStartDate
                + ", moneyStopDate=" + moneyStopDate + ", remark=" + remark + ", operatePerson=" + operatePerson + "}";
    }
}
