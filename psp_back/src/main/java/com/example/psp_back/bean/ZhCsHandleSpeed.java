...
public class ZhCsHandleSpeed implements Serializable {
    ...
    public String toString() {
        return "ZhCsHandleSpeed{" + "id=" + id + ", serviceId=" + serviceId + ", transactorName=" + transactorName
                + ", transactorDate=" + transactorDate + ", transactorContent=" + transactorContent + ", recorderId="
                + recorderId + ", recorderName=" + recorderName + ", recorderDate=" + recorderDate + "}";
    }
}
