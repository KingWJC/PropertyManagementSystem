...
public class TblDbsource implements Serializable {
    ...
    public String toString() {
        return "TblDbsource{" + "id=" + id + ", sourceName=" + sourceName + ", sourceDesc=" + sourceDesc
                + ", sourceType=" + sourceType + ", sourceClass=" + sourceClass + ", idClear=" + idClear
                + ", updateDate=" + updateDate + ", belongProduct=" + belongProduct + "}";
    }
}
