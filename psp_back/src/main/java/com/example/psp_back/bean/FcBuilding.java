...
public class FcBuilding implements Serializable {
    ...
    public String toString() {
        return "FcBuilding{" + "id=" + id + ", estateCode=" + estateCode + ", buildingCode=" + buildingCode
                + ", buildingName=" + buildingName + ", buildingFunction=" + buildingFunction + ", usedArea=" + usedArea
                + ", buildArea=" + buildArea + ", buildPermissionId=" + buildPermissionId + ", salePermissionId="
                + salePermissionId + ", finishDate=" + finishDate + ", overRoofDate=" + overRoofDate + ", decorate="
                + decorate + ", structType=" + structType + ", damageGrade=" + damageGrade + ", unitCount=" + unitCount
                + ", buildingType=" + buildingType + ", cleanFloor=" + cleanFloor + ", mopFloor=" + mopFloor
                + ", channelArea=" + channelArea + ", elevator=" + elevator + ", channelDoor=" + channelDoor
                + ", evevatorDoor=" + evevatorDoor + ", waterWellDoor=" + waterWellDoor + ", electricWellDoor="
                + electricWellDoor + ", windowShades=" + windowShades + ", hydrant=" + hydrant + ", mirrors=" + mirrors
                + ", unitDoor=" + unitDoor + ", hardenGroundArea=" + hardenGroundArea + ", greenArea=" + greenArea
                + ", noGreenArea=" + noGreenArea + ", waterByPerson=" + waterByPerson + ", isElevator=" + isElevator
                + ", isSecondWaterElectric=" + isSecondWaterElectric + ", randomIdentify=" + randomIdentify
                + ", remark=" + remark + "}";
    }
}
