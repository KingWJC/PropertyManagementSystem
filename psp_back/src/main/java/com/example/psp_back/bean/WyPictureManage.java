...
public class WyPictureManage implements Serializable {
    ...
    public String toString() {
        return "WyPictureManage{" + "id=" + id + ", pictureName=" + pictureName + ", pictureType=" + pictureType
                + ", desc=" + desc + ", pictureAttach=" + pictureAttach + ", company=" + company + ", uploadPerson="
                + uploadPerson + ", uploadDate=" + uploadDate + ", updatePerson=" + updatePerson + ", updateDate="
                + updateDate + "}";
    }
}
