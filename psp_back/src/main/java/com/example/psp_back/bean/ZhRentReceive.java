...
public class ZhRentReceive implements Serializable {
    ...
    public String toString() {
        return "ZhRentReceive{" + "id=" + id + ", contractId=" + contractId + ", rentId=" + rentId + ", rentName="
                + rentName + ", rentStartDate=" + rentStartDate + ", rentStopDate=" + rentStopDate + ", rentMoney="
                + rentMoney + ", desc=" + desc + ", receiveId=" + receiveId + ", receivePerson=" + receivePerson
                + ", receiveDate=" + receiveDate + ", receiveStatus=" + receiveStatus + ", invalidId=" + invalidId
                + ", invalidPersonName=" + invalidPersonName + ", invalidReason=" + invalidReason + ", invalidDate="
                + invalidDate + ", pastReceiveMethod=" + pastReceiveMethod + ", receiptCheckStatus="
                + receiptCheckStatus + ", receiptCheckPerson=" + receiptCheckPerson + ", receiptCheckTime="
                + receiptCheckTime + ", receiptCheckAdvice=" + receiptCheckAdvice + "}";
    }
}
