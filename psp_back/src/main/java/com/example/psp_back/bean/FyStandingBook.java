...
public class FyStandingBook implements Serializable {
    ...
    public String toString() {
        return "FyStandingBook{" + "id=" + id + ", standingBookName=" + standingBookName + ", associateCostCode="
                + associateCostCode + ", remark=" + remark + ", creationDate=" + creationDate + ", creationPerson="
                + creationPerson + ", associateStandingBookId=" + associateStandingBookId + ", company=" + company
                + "}";
    }
}
