...
public class ZhCustomerCheck implements Serializable {
    ...
    public String toString() {
        return "ZhCustomerCheck{" + "id=" + id + ", cellId=" + cellId + ", checkDate=" + checkDate + ", confirmDate="
                + confirmDate + ", checkItemId=" + checkItemId + ", checkItemName=" + checkItemName + ", isPass="
                + isPass + ", consumerAdvice=" + consumerAdvice + ", houseKeeperAdvice=" + houseKeeperAdvice
                + ", checkPerson=" + checkPerson + ", remark=" + remark + ", inputPerson=" + inputPerson
                + ", inputDate=" + inputDate + ", updatePerson=" + updatePerson + ", updateDate=" + updateDate
