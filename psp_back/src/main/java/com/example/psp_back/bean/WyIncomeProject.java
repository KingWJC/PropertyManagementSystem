...
public class WyIncomeProject implements Serializable {
    ...
    public String toString() {
        return "WyIncomeProject{" + "id=" + id + ", incomeProjectName=" + incomeProjectName + ", parentIncomeId="
                + parentIncomeId + ", desc=" + desc + ", createPerson=" + createPerson + ", createDate=" + createDate
