...
public class WyTakeoverDataDetail implements Serializable {
    ...
    public String toString() {
        return "WyTakeoverDataDetail{" + "id=" + id + ", takeoverId=" + takeoverId + ", dataName=" + dataName
                + ", dataCopies=" + dataCopies + ", dataPages=" + dataPages + ", dataType=" + dataType + ", fileNumber="
                + fileNumber + ", handoverPerson=" + handoverPerson + ", receivePerson=" + receivePerson
                + ", receiveDate=" + receiveDate + ", remark=" + remark + "}";
    }
}
