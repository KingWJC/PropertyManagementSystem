...
public class FcEstate implements Serializable {
    ...
    public String toString() {
        return "FcEstate{" + "id=" + id + ", estateCode=" + estateCode + ", estateName=" + estateName + ", estateAddr="
                + estateAddr + ", coverArea=" + coverArea + ", buildArea=" + buildArea + ", greenArea=" + greenArea
                + ", roadArea=" + roadArea + ", buildingNumber=" + buildingNumber + ", buildingLeader=" + buildingLeader
                + ", companyName=" + companyName + ", companyBehalf=" + companyBehalf + ", contact=" + contact
                + ", contactPhone=" + contactPhone + ", contactAddr=" + contactAddr + ", carSpaceDelayRate="
                + carSpaceDelayRate + ", carSpaceOverDay=" + carSpaceOverDay + ", estateType=" + estateType
                + ", streetLampNumber=" + streetLampNumber + ", hfcNum=" + hfcNum + ", remark=" + remark + ", company="
                + company + "}";
    }
}
