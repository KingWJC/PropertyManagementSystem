...
public class ZhCustomerMembers implements Serializable {
    ...
    public String toString() {
        return "ZhCustomerMembers{" + "id=" + id + ", belongCustomerId=" + belongCustomerId + ", name=" + name
                + ", birdate=" + birdate + ", gender=" + gender + ", ration=" + ration + ", certificateType="
                + certificateType + ", certificateNumber=" + certificateNumber + ", education=" + education
                + ", remark=" + remark + ", workPlace=" + workPlace + ", phoneNumber=" + phoneNumber + ", picture="
                + picture + "}";
    }
}
