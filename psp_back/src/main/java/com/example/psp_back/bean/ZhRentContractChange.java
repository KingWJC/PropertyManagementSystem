...
public class ZhRentContractChange implements Serializable {
    ...
    public String toString() {
        return "ZhRentContractChange{" + "id=" + id + ", contractId=" + contractId + ", changeProject=" + changeProject
                + ", oldValue=" + oldValue + ", newValue=" + newValue + ", desc=" + desc + ", changePerson="
                + changePerson + ", changeDate=" + changeDate + "}";
    }
}
