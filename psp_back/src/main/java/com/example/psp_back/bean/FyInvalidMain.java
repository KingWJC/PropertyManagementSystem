...
public class FyInvalidMain implements Serializable {
    ...
    public String toString() {
        return "FyInvalidMain{" + "invalidId=" + invalidId + ", receiveId=" + receiveId + ", cellId=" + cellId
                + ", receiveDate=" + receiveDate + ", customerName=" + customerName + ", money=" + money
                ...
                + lastDelayMoney + ", invalidType=" + invalidType + ", receiptNumber=" + receiptNumber
                + ", invoiceNumber=" + invoiceNumber + ", receivePerson=" + receivePerson + ", remark=" + remark
                + ", company=" + company + ", invalidReason=" + invalidReason + ", invalidDate=" + invalidDate
