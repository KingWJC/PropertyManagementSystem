...
public class WyVisitManage implements Serializable {
    ...
    public String toString() {
        return "WyVisitManage{" + "id=" + id + ", visitDate=" + visitDate + ", leaveDate=" + leaveDate
                + ", visitPerson=" + visitPerson + ", idCard=" + idCard + ", visitAddr=" + visitAddr + ", visitReason="
                + visitReason + ", visitedPerson=" + visitedPerson + ", visitedReason=" + visitedReason + ", agent="
                + agent + ", remark=" + remark + ", company=" + company + "}";
    }
}
