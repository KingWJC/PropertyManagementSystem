...
public class TblMainMenu implements Serializable {
    ...
    public String toString() {
        return "TblMainMenu{" + "id=" + id + ", mainMenuName=" + mainMenuName + ", mainMenuUrl=" + mainMenuUrl
                + ", mainMenuIcon=" + mainMenuIcon + ", mainMenuStatus=" + mainMenuStatus + ", mainMenuKey="
                + mainMenuKey + ", mainMenuOrder=" + mainMenuOrder + ", belongProduct=" + belongProduct + "}";
    }
}
