...
public class TblDept implements Serializable {
    ...
    public String toString() {
        return "TblDept{" + "id=" + id + ", deptCode=" + deptCode + ", deptName=" + deptName + ", deptLeader="
                + deptLeader + ", deptPhone=" + deptPhone + ", deptType=" + deptType + ", deptFax=" + deptFax
                + ", deptParent=" + deptParent + ", deptLine=" + deptLine + ", deptPrivileges=" + deptPrivileges
                + ", deptManagePrivileges=" + deptManagePrivileges + ", organCategory=" + organCategory
                + ", deptPersonNumber=" + deptPersonNumber + ", inputPerson=" + inputPerson + ", inputTime=" + inputTime
