...
public class WyEstateOutDetail implements Serializable {
    ...
    public String toString() {
        return "WyEstateOutDetail{" + "id=" + id + ", chargeDate=" + chargeDate + ", estateId=" + estateId
                + ", outputMainProject=" + outputMainProject + ", outputSubProject=" + outputSubProject
                + ", outputMoney=" + outputMoney + ", outputMoneyYear=" + outputMoneyYear + ", outputMoneyMain="
                + outputMoneyMain + ", status=" + status + ", desc=" + desc + ", createPerson=" + createPerson
                + ", createDate=" + createDate + ", updatePerson=" + updatePerson + ", updateDate=" + updateDate
                + ", nextReceivePersonId=" + nextReceivePersonId + ", nextReceivePersonName=" + nextReceivePersonName
