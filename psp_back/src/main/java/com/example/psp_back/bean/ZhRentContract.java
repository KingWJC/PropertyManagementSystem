...
public class ZhRentContract implements Serializable {
    ...
    public String toString() {
        return "ZhRentContract{" + "id=" + id + ", contractId=" + contractId + ", signDate=" + signDate + ", startDate="
                + startDate + ", stopDate=" + stopDate + ", rentId=" + rentId + ", contact=" + contact
                + ", startRentDate=" + startRentDate + ", stopRentDate=" + stopRentDate + ", contractRentMoney="
                + contractRentMoney + ", receiveArea=" + receiveArea + ", contractStatus=" + contractStatus
                + ", ensureMoney=" + ensureMoney + ", ensureMoneyDesc=" + ensureMoneyDesc + ", contractAttach="
                + contractAttach + ", rentDays=" + rentDays + ", adminMoney=" + adminMoney + ", isRentMoney="
                + isRentMoney + ", payMethod=" + payMethod + ", remark=" + remark + ", createPerson=" + createPerson
                + ", createDate=" + createDate + ", updatePerson=" + updatePerson + ", updateDate=" + updateDate
                + ", attractPersonId=" + attractPersonId + ", attractPersonName=" + attractPersonName + ", company="
                + company + "}";
    }
}
