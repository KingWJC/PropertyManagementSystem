...
public class WyRenewMsgRemindLog implements Serializable {
    ...
    public String toString() {
        return "WyRenewMsgRemindLog{" + "id=" + id + ", cellId=" + cellId + ", moneyId=" + moneyId + ", receivePhone="
                + receivePhone + ", moneyStopDate=" + moneyStopDate + ", remindDays=" + remindDays + ", cellName="
                + cellName + ", sendPersonId=" + sendPersonId + ", sendPersonName=" + sendPersonName + ", sendDate="
                + sendDate + "}";
    }
}
