...
public class TblSystemLog implements Serializable {
    ...
    public String toString() {
        return "TblSystemLog{" + "id=" + id + ", logContent=" + logContent + ", modelId=" + modelId + ", ipAddr="
                + ipAddr + ", deptPrivileges=" + deptPrivileges + ", operateId=" + operateId + ", operateName="
                + operateName + ", deptId=" + deptId + ", deptName=" + deptName + ", operateDate=" + operateDate + "}";
    }
}
