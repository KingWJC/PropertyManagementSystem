...
public class FyPublicBox implements Serializable {
    ...
    public String toString() {
        return "FyPublicBox{" + "publicBoxId=" + publicBoxId + ", moneyId=" + moneyId + ", publicBoxReadNumber="
                + publicBoxReadNumber + ", shareMethod=" + shareMethod + ", publicBoxState=" + publicBoxState + "}";
    }
}
